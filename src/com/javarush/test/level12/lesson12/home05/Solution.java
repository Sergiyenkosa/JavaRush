...
public class Solution
{
    ...
    public static String getObjectType(Object o)
    {
        ...
        if (o.getClass().equals(new Cat().getClass()))
            return "Кот";
        else if (o.getClass().equals(new Tiger().getClass()))
            return "Тигр";
        else if (o.getClass().equals(new Lion().getClass()))
            return "Лев";
        else if (o.getClass().equals(new Bull().getClass()))
            return "Бык";
        else if (o.getClass().equals(new Cow().getClass()))
            return "Корова";
        return "Животное";
    }
