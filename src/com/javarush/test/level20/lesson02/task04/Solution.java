...
public class Solution {
    public static void main(String[] args) {
        ...
        try {
            ...
            System.out.println(loadedObject.i + " " + loadedObject.j + " " + ClassWithStatic.staticString);
    ...
    public static class ClassWithStatic {
        ...
        public void save(OutputStream outputStream) throws Exception {
            ...
            String isStaticStringPresent = staticString != null ? "yes" : "no";
            writer.println(isStaticStringPresent);
            if (isStaticStringPresent.equals("yes")){
        ...
        public void load(InputStream inputStream) throws Exception {
            ...
            String isStaticStringPresent = reader.readLine();
            if (isStaticStringPresent.equals("yes")){
