        ...
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                if (!(stock1.get("name").equals(stock2.get("name")))){
                    String[] strings = {(String) stock1.get("name"), (String) stock2.get("name")};
                    Arrays.sort(strings);
                    if (strings[0].equals(stock1.get("name"))){
                        return -1;
                    }
                    else {
                        return 1;
                ...
                calendar1.setTime((Date) stock1.get("date"));
                Calendar calendar2 = Calendar.getInstance();
                calendar2.setTime((Date) stock2.get("date"));
